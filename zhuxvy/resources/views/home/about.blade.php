...
@section("style")
    ...
    <style>
        ...
        #lanren #audio-btn{width: 44px;height: 44px; margin:100px auto;background-size: 100% 100%; position:fixed;bottom:50px;right:0px;}
        #lanren .on{background: url('{{URL::asset('music/music_on.png')}}') no-repeat 0 0;-webkit-animation: rotating 1.2s linear infinite;animation: rotating 1.2s linear infinite;}
        #lanren .off{background: url('{{URL::asset('music/music_off.png')}}') no-repeat 0 0;}
...
@section("content")
                            ...
                            <div class="aboutinfo">
                                ...
                                <fieldset class="layui-elem-field layui-field-title">
                                    ...
                                    <div class="layui-field-box aboutinfo-abstract">
                                        ...
                                        <h1>第一个版本</h1>
                                        <p>诞生的版本，采用PHP MVC LARAVEL5.5作为后台框架，前端摘自 <a href="http://www.lyblogs.cn/">不落阁</a>，用了Layui的栅格系统来布局！起初并没有注意美工，只打算完成基本的功能，故视觉体验是比较差的。写页面，不存在。</p>
    ...
    <div id="lanren">
        <div id="audio-btn" class="on" onclick="lanren.changeClass(this,'media')">
            <audio loop="loop" src="{{URL::asset('/music/yujian.mp3')}}" id="media" autoplay="autoplay" preload="preload"></audio>
        </div>
    </div>
