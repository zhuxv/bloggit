        ...
        <div class="layui-side">
            <div class="layui-side-scroll">
                <ul class="layui-nav layui-nav-tree" lay-filter="leftnav">
                    ...
                    <li class="layui-nav-item @if(explode('@',Route::current()->getActionName())[0] == 'App\Http\Controllers\Admin\ExtendController' || explode('@',Route::current()->getActionName())[0] == 'App\Http\Controllers\Admin\NoticeController' || explode('@',Route::current()->getActionName())[0] == 'App\Http\Controllers\Admin\TimelineController' || explode('@',Route::current()->getActionName())[0] == 'App\Http\Controllers\Admin\MessageController') layui-nav-itemed @endif">
                        ...
                        <dl class="layui-nav-child">
                            ...
                            <dd @if(explode('@',Route::current()->getActionName())[0] == 'App\Http\Controllers\Admin\MessageController') class="layui-this" @endif><a href="{{action('Admin\MessageController@index')}}">留言管理</a></dd>
                        </dl>
                    </li>
